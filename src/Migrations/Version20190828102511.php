 ...
 */
final class Version20190828102511 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE imagenes_hotel (id INT AUTO_INCREMENT NOT NULL, id_hotel_id INT NOT NULL, url VARCHAR(1000) NOT NULL, INDEX IDX_AEBAF2DF6298578D (id_hotel_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE linea_pedido (id INT AUTO_INCREMENT NOT NULL, id_pedido_id INT DEFAULT NULL, id_pack_id INT NOT NULL, id_estancia_id INT DEFAULT NULL, precio DOUBLE PRECISION NOT NULL, fecha_fin DATE NOT NULL, usado TINYINT(1) NOT NULL, INDEX IDX_183C3165C861D91D (id_pedido_id), INDEX IDX_183C3165C7841B67 (id_pack_id), INDEX IDX_183C316525379932 (id_estancia_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE pedido (id INT AUTO_INCREMENT NOT NULL, id_usuario_id INT NOT NULL, fecha DATE DEFAULT NULL, INDEX IDX_C4EC16CE7EB2C349 (id_usuario_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE linea_pedido ADD CONSTRAINT FK_183C3165C861D91D FOREIGN KEY (id_pedido_id) REFERENCES pedido (id)');
        $this->addSql('ALTER TABLE linea_pedido ADD CONSTRAINT FK_183C3165C7841B67 FOREIGN KEY (id_pack_id) REFERENCES pack (id)');
        $this->addSql('ALTER TABLE linea_pedido ADD CONSTRAINT FK_183C316525379932 FOREIGN KEY (id_estancia_id) REFERENCES estancia (id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE linea_pedido DROP FOREIGN KEY FK_183C316525379932');
        ...
        $this->addSql('ALTER TABLE linea_pedido DROP FOREIGN KEY FK_183C3165C7841B67');
        $this->addSql('ALTER TABLE linea_pedido DROP FOREIGN KEY FK_183C3165C861D91D');
