 ...
 */
final class Version20190826103228 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user ADD usuario VARCHAR(50) DEFAULT NULL, ADD nombre VARCHAR(200) DEFAULT NULL, ADD apellidos VARCHAR(500) DEFAULT NULL, ADD direccion VARCHAR(400) DEFAULT NULL, ADD ciudad VARCHAR(400) DEFAULT NULL, ADD fecha_nacimiento DATE DEFAULT NULL, ADD fecha_registro DATE DEFAULT NULL, CHANGE roles roles JSON NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user DROP usuario, DROP nombre, DROP apellidos, DROP direccion, DROP ciudad, DROP fecha_nacimiento, DROP fecha_registro, CHANGE roles roles LONGTEXT NOT NULL COLLATE utf8mb4_bin');
