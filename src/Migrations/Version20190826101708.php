 ...
 */
final class Version20190826101708 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE usuario (id INT AUTO_INCREMENT NOT NULL, usuario VARCHAR(50) DEFAULT NULL, password VARCHAR(1000) DEFAULT NULL, nombre VARCHAR(200) DEFAULT NULL, apellidos VARCHAR(500) DEFAULT NULL, correo VARCHAR(200) DEFAULT NULL, direccion VARCHAR(400) DEFAULT NULL, ciudad VARCHAR(400) DEFAULT NULL, rol VARCHAR(100) DEFAULT NULL, fecha_nacimiento DATE DEFAULT NULL, fecha_registro DATE DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
    }
