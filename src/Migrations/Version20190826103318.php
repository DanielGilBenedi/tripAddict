 ...
 */
final class Version20190826103318 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user CHANGE roles roles JSON NOT NULL, CHANGE usuario usuario VARCHAR(50) DEFAULT NULL, CHANGE nombre nombre VARCHAR(200) DEFAULT NULL, CHANGE apellidos apellidos VARCHAR(500) DEFAULT NULL, CHANGE direccion direccion VARCHAR(400) DEFAULT NULL, CHANGE ciudad ciudad VARCHAR(400) DEFAULT NULL, CHANGE fecha_nacimiento fecha_nacimiento DATE DEFAULT NULL, CHANGE fecha_registro fecha_registro DATE DEFAULT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE usuario (id INT AUTO_INCREMENT NOT NULL, usuario VARCHAR(50) DEFAULT \'NULL\' COLLATE utf8mb4_unicode_ci, password VARCHAR(1000) DEFAULT \'NULL\' COLLATE utf8mb4_unicode_ci, nombre VARCHAR(200) DEFAULT \'NULL\' COLLATE utf8mb4_unicode_ci, apellidos VARCHAR(500) DEFAULT \'NULL\' COLLATE utf8mb4_unicode_ci, correo VARCHAR(200) DEFAULT \'NULL\' COLLATE utf8mb4_unicode_ci, direccion VARCHAR(400) DEFAULT \'NULL\' COLLATE utf8mb4_unicode_ci, ciudad VARCHAR(400) DEFAULT \'NULL\' COLLATE utf8mb4_unicode_ci, rol VARCHAR(100) DEFAULT \'NULL\' COLLATE utf8mb4_unicode_ci, fecha_nacimiento DATE DEFAULT \'NULL\', fecha_registro DATE DEFAULT \'NULL\', PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB COMMENT = \'\' ');
